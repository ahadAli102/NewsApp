...
public class FilterLanguageAdapter extends RecyclerView.Adapter<FilterLanguageAdapter.FilterViewHolder>{
    private List<FilterData> mData;
    private static final String TAG = "MyTAG:Filter:LnA";
    Context mContext;
    public FilterLanguageAdapter(Context context,String filterData) {
        this.mData = FilterDataProvider.getFilterLanguages();
